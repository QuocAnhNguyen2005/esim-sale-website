...
const MOCK_ORDERS = [
  { id: 'ORD-A1', status: 'PAID', channel: 'App Ngân hàng', total: '$12.00', date: '2026-05-28', iccid: '89840220019...' },
  { id: 'ORD-A2', status: 'PAID', channel: 'WebGoc', total: '$35.00', date: '2026-05-28', iccid: '89840220054...' },
  { id: 'ORD-B1', status: 'FAILED_API', channel: 'App Ngân hàng', total: '$19.00', date: '2026-05-28', iccid: 'PENDING' },
];
    ...
    <div className="space-y-6 animate-in fade-in duration-300">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          ...
          <p className="text-sm text-gray-500 mt-1">Bảng điều khiển theo dõi trạng thái cấp phát từ nhà mạng viễn thông.</p>
        </div>
      </div>
                  ...
                  <td className="p-4 text-right">
                    {order.status === 'FAILED_API' ? (
                      <div className="flex justify-end gap-2">
                        <button className="px-3 py-1.5 bg-indigo-600 text-white text-xs font-bold rounded flex items-center gap-1 hover:bg-indigo-700 shadow-sm"><RefreshCw className="w-3 h-3" /> Force Retry</button>
                        <button className="px-3 py-1.5 bg-red-50 text-red-600 text-xs font-bold rounded hover:bg-red-100 border border-red-100">Refund</button>
                      </div>
                    ) : (
